 ...
 * @author Paralytic
 */
public class FileCloudCcAccount extends AbstractAccount{
    ...
    public FileCloudCcAccount() {
        KEY_USERNAME = "flcloudccusername";
        KEY_PASSWORD = "flcloudccpassword";
        HOSTNAME = "FileCloud.cc";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to FileCloud.cc");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("FileCloud.cc login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("FileCloudCcAccount.html", responseString);
