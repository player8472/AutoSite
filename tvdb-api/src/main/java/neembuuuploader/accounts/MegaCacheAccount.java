 ...
 */
public class MegaCacheAccount extends AbstractAccount{
    ...
    public MegaCacheAccount() {
        KEY_USERNAME = "mgcchusername";
        KEY_PASSWORD = "mgcchpassword";
        HOSTNAME = "MegaCache.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to MegaCache.net");
            ...
            if (lastHeader != null && lastHeader.getValue().contains("op=my_files")) {
                ...
                NULogger.getLogger().info("MegaCache.net login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("MegaCacheAccount.html", responseString);
