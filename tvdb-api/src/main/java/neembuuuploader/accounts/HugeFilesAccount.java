 ...
 */
public class HugeFilesAccount extends AbstractAccount{
    ...
    public HugeFilesAccount() {
        KEY_USERNAME = "hgflsusername";
        KEY_PASSWORD = "hgflspassword";
        HOSTNAME = "HugeFiles.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to HugeFiles.net");
            ...
            if (lastHeader != null && lastHeader.getValue().contains("op=my_files")) {
                ...
                NULogger.getLogger().info("HugeFiles.net login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("HugeFilesAccount.html", responseString);
