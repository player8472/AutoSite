 ...
 * @author Paralytic
 */
public class GBoxesAccount extends AbstractAccount{
    ...
    public GBoxesAccount() {
        KEY_USERNAME = "gboxesusername";
        KEY_PASSWORD = "gboxespassword";
        HOSTNAME = "GBoxes.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to GBoxes.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("GBoxes.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("GBoxesAccount.html", responseString);
