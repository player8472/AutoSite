 ...
 * @author Paralytic
 */
public class SafeSharingAccount extends AbstractAccount{
    ...
    public SafeSharingAccount() {
        KEY_USERNAME = "safeshrusername";
        KEY_PASSWORD = "safeshrpassword";
        HOSTNAME = "SafeSharing.eu";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to SafeSharing.eu");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("SafeSharing.eu login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("SafeSharingAccount.html", responseString);
