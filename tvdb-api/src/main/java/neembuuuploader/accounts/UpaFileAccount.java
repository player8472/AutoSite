 ...
 * @author Paralytic
 */
public class UpaFileAccount extends AbstractAccount{
    ...
    public UpaFileAccount() {
        KEY_USERNAME = "upaflusername";
        KEY_PASSWORD = "upaflpassword";
        HOSTNAME = "UpaFile.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to UpaFile.com");
            httpPost = new NUHttpPost("http://upafile.com/login.html");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("UpaFile.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("UpaFileAccount.html", responseString);
