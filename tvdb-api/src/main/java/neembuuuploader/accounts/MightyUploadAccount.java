 ...
 * @author Paralytic
 */
public class MightyUploadAccount extends AbstractAccount{
    ...
    public MightyUploadAccount() {
        KEY_USERNAME = "mghtyupusername";
        KEY_PASSWORD = "mghtyuppassword";
        HOSTNAME = "MightyUpload.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to MightyUpload.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("MightyUpload.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("MightyUploadAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from MightyUpload.com");
        //responseString = NUHttpClientUtils.getData("http://mightyupload.com", httpContext);
    }
