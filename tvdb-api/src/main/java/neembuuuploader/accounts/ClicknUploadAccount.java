 ...
 * @author Paralytic
 */
public class ClicknUploadAccount extends AbstractAccount{
    ...
    public ClicknUploadAccount() {
        KEY_USERNAME = "clknupusername";
        KEY_PASSWORD = "clknuppassword";
        HOSTNAME = "ClicknUpload.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to ClicknUpload.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("ClicknUpload.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("ClicknUploadAccount.html", responseString);
