 ...
 * @author Paralytic
 */
public class VShareAccount extends AbstractAccount{
    ...
    public VShareAccount() {
        KEY_USERNAME = "vshareusername";
        KEY_PASSWORD = "vsharepassword";
        HOSTNAME = "VShare.eu";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to VShare.eu");
            ...
            if (httpResponse != null && httpResponse.toString().contains("xfss=")) {
                ...
                NULogger.getLogger().info("VShare.eu login successful!");
            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("VShareAccount.html", responseString);
