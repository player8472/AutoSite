 ...
 * @author Paralytic
 */
public class UploadBoyAccount extends AbstractAccount{
    ...
    public UploadBoyAccount() {
        KEY_USERNAME = "upboyusername";
        KEY_PASSWORD = "upboypassword";
        HOSTNAME = "UploadBoy.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to UploadBoy.com");
            ...
            if (httpResponse != null && httpResponse.toString().contains("xfss=")) {
                ...
                NULogger.getLogger().info("UploadBoy.com login successful!");
            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("UploadBoyAccount.html", responseString);
