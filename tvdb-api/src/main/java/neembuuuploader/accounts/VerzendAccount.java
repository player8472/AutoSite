 ...
 * @author Paralytic
 */
public class VerzendAccount extends AbstractAccount{
    ...
    public VerzendAccount() {
        KEY_USERNAME = "verzendusername";
        KEY_PASSWORD = "verzendpassword";
        HOSTNAME = "Verzend.be";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to Verzend.be");
            httpPost = new NUHttpPost("http://verzend.be/");

            List<NameValuePair> formparams = new ArrayList<NameValuePair>();
            formparams.add(new BasicNameValuePair("op", "login"));
            formparams.add(new BasicNameValuePair("redirect", "http://verzend.be/login.html"));
            ...
            if (httpResponse != null && httpResponse.toString().contains("xfss=")) {
                ...
                NULogger.getLogger().info("Verzend.be login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("VerzendAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        NULogger.getLogger().info("Getting startup cookies & link from Verzend.be");
        responseString = NUHttpClientUtils.getData("http://verzend.be/login.html", httpContext);
    }
