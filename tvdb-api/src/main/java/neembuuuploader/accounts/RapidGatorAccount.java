...
public class RapidGatorAccount extends AbstractAccount {
    ...
    public void disableLogin() {
        ...
        HostsPanel.getInstance().rapidGatorCheckBox.setEnabled(false);
        HostsPanel.getInstance().rapidGatorCheckBox.setSelected(false);
...
//                NULogger.getLogger().info(escookie.getName() + " : " + escookie.getValue());
            ...
            */
            ...
            if (CookieUtils.existCookie(httpContext, "user")) {
                ...
                HostsPanel.getInstance().rapidGatorCheckBox.setEnabled(true);
