 ...
 */
public class TusFilesAccount extends AbstractAccount{
    ...
    public TusFilesAccount() {
        KEY_USERNAME = "tsflsusername";
        KEY_PASSWORD = "tsflspassword";
        HOSTNAME = "TusFiles.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to TusFiles.net");
            httpPost = new NUHttpPost("https://www.tusfiles.net");
            ...
            if (lastHeader != null && lastHeader.getValue().contains("op=my_files")) {
                ...
                NULogger.getLogger().info("TusFiles.net login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("TusFilesAccount.html", responseString);
                Document doc = Jsoup.parse(responseString);
                Element element = doc.select(".error").first();
