 ...
 * @author Paralytic
 */
public class MyDiscAccount extends AbstractAccount{
    ...
    public MyDiscAccount() {
        KEY_USERNAME = "mydscusername";
        KEY_PASSWORD = "mydscpassword";
        HOSTNAME = "MyDisc.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to MyDisc.net");
            ...
            if (httpResponse != null && httpResponse.toString().contains("xfss=")) {
                ...
                NULogger.getLogger().info("MyDisc.net login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("MyDiscAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from MyDisc.net");
        //responseString = NUHttpClientUtils.getData("http://mydisc.net", httpContext);
    }
