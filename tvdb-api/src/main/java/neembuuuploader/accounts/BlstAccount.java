 ...
 * @author MNidhal
 */
public class BlstAccount extends AbstractAccount{
    ...
    public BlstAccount() {
        KEY_USERNAME = "blstusername";
        KEY_PASSWORD = "blstpassword";
        HOSTNAME = "Bl.st";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to Bl.st");
            ...
            if (lastHeader != null && lastHeader.getValue().contains("op=my_account")) {
                ...
                //Is the user premium?
                responseString = NUHttpClientUtils.getData("https://www.bl.st/account", httpContext);
                responseString = Jsoup.parse(responseString).select("div.row div:eq(1)").first().text();
                ...
                NULogger.getLogger().info("Bl.st login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("BlstAccount.html", responseString);
