 ...
 * @author Paralytic
 */
public class FileDaisAccount extends AbstractAccount{
    ...
    public FileDaisAccount() {
        KEY_USERNAME = "fldaisusername";
        KEY_PASSWORD = "fldaispassword";
        HOSTNAME = "FileDais.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to FileDais.com");
            httpPost = new NUHttpPost("http://filedais.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("FileDais.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("FileDaisAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from FileDais.com");
