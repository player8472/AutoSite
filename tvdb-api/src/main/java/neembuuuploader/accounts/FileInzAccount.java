 ...
 * @author Paralytic
 */
public class FileInzAccount extends AbstractAccount{
    ...
    public FileInzAccount() {
        KEY_USERNAME = "flinzusername";
        KEY_PASSWORD = "flinzpassword";
        HOSTNAME = "FileInz.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to FileInz.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("FileInz.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("FileInzAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from FileInz.com");
