 ...
 */
public class UploadDriveAccount extends AbstractAccount{
    ...
    public UploadDriveAccount() {
        KEY_USERNAME = "upldrvusername";
        KEY_PASSWORD = "upldrvpassword";
        HOSTNAME = "UploadDrive.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to UploadDrive.com");
            ...
            if (lastHeader != null && lastHeader.getValue().contains("op=my_files")) {
                ...
                NULogger.getLogger().info("UploadDrive.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("UploadDriveAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from UploadDrive.com");
