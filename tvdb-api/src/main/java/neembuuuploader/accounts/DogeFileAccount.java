 ...
 * @author Paralytic
 */
public class DogeFileAccount extends AbstractAccount{
    ...
    public DogeFileAccount() {
        KEY_USERNAME = "dogeflusername";
        KEY_PASSWORD = "dogeflpassword";
        HOSTNAME = "DogeFile.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to DogeFile.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("DogeFile.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("DogeFileAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from DogeFile.com");
