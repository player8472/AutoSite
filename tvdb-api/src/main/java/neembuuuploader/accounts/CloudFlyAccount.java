 ...
 * @author Paralytic
 */
public class CloudFlyAccount extends AbstractAccount{
    ...
    public CloudFlyAccount() {
        KEY_USERNAME = "cloudflyusername";
        KEY_PASSWORD = "cloudflypassword";
        HOSTNAME = "CloudFly.us";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to CloudFly.us");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("CloudFly.us login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("CloudFlyAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from CloudFly.us");
