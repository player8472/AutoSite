 ...
 * @author Paralytic
 */
public class FileViceAccount extends AbstractAccount{
    ...
    public FileViceAccount() {
        KEY_USERNAME = "flviceusername";
        KEY_PASSWORD = "flvicepassword";
        HOSTNAME = "FileVice.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to FileVice.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("FileVice.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("FileViceAccount.html", responseString);
