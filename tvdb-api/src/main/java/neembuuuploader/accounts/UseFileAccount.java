 ...
 * @author Paralytic
 */
public class UseFileAccount extends AbstractAccount{
    ...
    public UseFileAccount() {
        KEY_USERNAME = "usefileusername";
        KEY_PASSWORD = "usefilepassword";
        HOSTNAME = "UseFile.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to UseFile.com");
            httpPost = new NUHttpPost("http://usefile.com/");

            List<NameValuePair> formparams = new ArrayList<NameValuePair>();
            formparams.add(new BasicNameValuePair("op", "login"));
            formparams.add(new BasicNameValuePair("redirect", "http://usefile.com/"));
            ...
            if (httpResponse != null && httpResponse.toString().contains("xfss=")) {
                ...
                NULogger.getLogger().info("UseFile.com login successful!");
                
            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("UseFileAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from UseFile.com");
