 ...
 * @author MNidhal
 */
public class YouWatchAccount extends AbstractAccount{
    ...
    public YouWatchAccount() {
        KEY_USERNAME = "ywtchusername";
        KEY_PASSWORD = "ywtchpassword";
        HOSTNAME = "YouWatch.org";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to YouWatch.org");
            ...
            if (lastHeader != null && lastHeader.getValue().contains("op=my_files")) {
                ...
                NULogger.getLogger().info("YouWatch.org login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("YouWatchAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from YouWatch.org");
        //responseString = NUHttpClientUtils.getData("http://youwatch.org/", httpContext);
    }
