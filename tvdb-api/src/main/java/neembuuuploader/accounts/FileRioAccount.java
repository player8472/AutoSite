 ...
 */
public class FileRioAccount extends AbstractAccount{
    ...
    public FileRioAccount() {
        KEY_USERNAME = "flrusername";
        KEY_PASSWORD = "flrpassword";
        HOSTNAME = "FileRio.in";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to FileRio.in");
            ...
            if (lastHeader != null && lastHeader.getValue().contains("op=my_files")) {
                ...
                NULogger.getLogger().info("FileRio.in login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("FileRioAccount.html", responseString);
