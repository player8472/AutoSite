 ...
 */
public class KingFilesAccount extends AbstractAccount{
    ...
    public KingFilesAccount() {
        KEY_USERNAME = "kngflsusername";
        KEY_PASSWORD = "kngflspassword";
        HOSTNAME = "KingFiles.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to KingFiles.net");
            ...
            if (lastHeader != null && lastHeader.getValue().contains("op=my_files")) {
                ...
                NULogger.getLogger().info("KingFiles.net login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("KingFilesAccount.html", responseString);
