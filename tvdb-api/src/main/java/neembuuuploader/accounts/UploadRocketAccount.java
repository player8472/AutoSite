 ...
 * @author Paralytic
 */
public class UploadRocketAccount extends AbstractAccount{
    ...
    public UploadRocketAccount() {
        KEY_USERNAME = "uprcktusername";
        KEY_PASSWORD = "uprcktpassword";
        HOSTNAME = "UploadRocket.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to UploadRocket.net");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("UploadRocket.net login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("UploadRocketAccount.html", responseString);
