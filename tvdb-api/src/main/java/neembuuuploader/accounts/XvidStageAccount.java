 ...
 * @author MNidhal
 */
public class XvidStageAccount extends AbstractAccount{
    ...
    public XvidStageAccount() {
        KEY_USERNAME = "xvidusername";
        KEY_PASSWORD = "xvidpassword";
        HOSTNAME = "XvidStage.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to XvidStage.com");
            ...
            if (lastHeader != null && lastHeader.getValue().contains("op=my_files")) {
                ...
                NULogger.getLogger().info("XvidStage.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("XvidStageAccount.html", responseString);
