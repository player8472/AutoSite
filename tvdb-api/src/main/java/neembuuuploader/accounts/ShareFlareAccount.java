 ...
 */
public class ShareFlareAccount extends AbstractAccount{
    ...
    public ShareFlareAccount() {
        KEY_USERNAME = "shrflrusername";
        KEY_PASSWORD = "shrflrpassword";
        HOSTNAME = "ShareFlare.net";
    }

    @Override
    public void disableLogin() {
        resetLogin();
        HostsPanel.getInstance().shareFlareCheckBox.setEnabled(false);
        HostsPanel.getInstance().shareFlareCheckBox.setSelected(false);
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to ShareFlare.net");
            httpPost = new NUHttpPost("http://shareflare.net");
            ...
            if (lastHeader != null && lastHeader.getValue().contains("index.php")) {
                EntityUtils.consume(httpResponse.getEntity());
                loginsuccessful = true;
                HostsPanel.getInstance().shareFlareCheckBox.setEnabled(true);
                username = getUsername();
                password = getPassword();
                NULogger.getLogger().info("ShareFlare.net login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("ShareFlareAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from ShareFlare.net");
