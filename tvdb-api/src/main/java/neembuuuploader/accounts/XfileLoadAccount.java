 ...
 * @author Paralytic
 */
public class XfileLoadAccount extends AbstractAccount{
    ...
    public XfileLoadAccount() {
        KEY_USERNAME = "xfileloadusername";
        KEY_PASSWORD = "xfileloadpassword";
        HOSTNAME = "XfileLoad.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to XfileLoad.com");
            ...
            if (httpResponse != null && httpResponse.toString().contains("xfss=") && httpResponse.toString().contains("login=")) {
                EntityUtils.consume(httpResponse.getEntity());
                loginsuccessful = true;
                username = getUsername();
                password = getPassword();
                NULogger.getLogger().info("XfileLoad.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("XfileLoadAccount.html", responseString);
