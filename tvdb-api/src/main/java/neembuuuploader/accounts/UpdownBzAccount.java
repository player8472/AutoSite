...
public class UpdownBzAccount extends AbstractAccount {
    ...
    public void disableLogin() {
        resetLogin();
        HostsPanel.getInstance().updownBzCheckBox.setEnabled(false);
        HostsPanel.getInstance().updownBzCheckBox.setSelected(false);
    ...
    public void login() {
        ...
        if (sessionId == null || sessionId.length() <= 0 || timeIsUp) {
            ...
            try {
                ...
                HostsPanel.getInstance().updownBzCheckBox.setEnabled(true);
