 ...
 * @author Paralytic
 */
public class VidBullAccount extends AbstractAccount{
    ...
    public VidBullAccount() {
        KEY_USERNAME = "vidbullusername";
        KEY_PASSWORD = "vidbullpassword";
        HOSTNAME = "VidBull.com";
    }

    @Override
    public void disableLogin() {
        resetLogin();
        HostsPanel.getInstance().vidBullCheckBox.setEnabled(false);
        HostsPanel.getInstance().vidBullCheckBox.setSelected(false);
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to VidBull.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                HostsPanel.getInstance().vidBullCheckBox.setEnabled(true);
                NULogger.getLogger().info("VidBull.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("VidBullAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from VidBull.com");
