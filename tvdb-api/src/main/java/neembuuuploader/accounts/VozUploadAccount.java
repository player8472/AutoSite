 ...
 * @author MNidhal
 */
public class VozUploadAccount extends AbstractAccount{
    ...
    public VozUploadAccount() {
        KEY_USERNAME = "vozuusername";
        KEY_PASSWORD = "vozupassword";
        HOSTNAME = "VozUpload.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to VozUpload.com");
            ...
            if (lastHeader != null && lastHeader.getValue().contains("op=my_files")) {
                ...
                NULogger.getLogger().info("VozUpload.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("VozUploadAccount.html", responseString);
