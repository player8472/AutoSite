 ...
 * @author Paralytic
 */
public class RainUploadAccount extends AbstractAccount{
    ...
    public RainUploadAccount() {
        KEY_USERNAME = "rainupusername";
        KEY_PASSWORD = "rainuppassword";
        HOSTNAME = "RainUpload.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to RainUpload.net");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("RainUpload.net login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("RainUploadAccount.html", responseString);
