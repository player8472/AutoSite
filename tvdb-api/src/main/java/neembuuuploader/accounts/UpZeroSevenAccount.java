 ...
 * @author Paralytic
 */
public class UpZeroSevenAccount extends AbstractAccount{
    ...
    public UpZeroSevenAccount() {
        KEY_USERNAME = "upzerosevenusername";
        KEY_PASSWORD = "upzerosevenpassword";
        HOSTNAME = "Up07.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to Up07.net");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("Up07.net login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("UpZeroSevenAccount.html", responseString);
