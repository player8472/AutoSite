 ...
 * @author Paralytic
 */
public class VidUpAccount extends AbstractAccount{
    ...
    public VidUpAccount() {
        KEY_USERNAME = "vidupusername";
        KEY_PASSWORD = "viduppassword";
        HOSTNAME = "VidUp.me";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to VidUp.me");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("VidUp.me login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("VidUpAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from VidUp.me");
