 ...
 * @author MNidhal
 */
public class VidXdenAccount extends AbstractAccount{
    ...
    public VidXdenAccount() {
        KEY_USERNAME = "vixdusername";
        KEY_PASSWORD = "vixdpassword";
        HOSTNAME = "VidXden.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to VidXden.com");
            ...
            if (lastHeader != null && lastHeader.getValue().contains("op=my_files")) {
                ...
                NULogger.getLogger().info("VidXden.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("VidXdenAccount.html", responseString);
