 ...
 * @author Paralytic
 */
public class FourUpFilesAccount extends AbstractAccount{
    ...
    public FourUpFilesAccount() {
        KEY_USERNAME = "fourupusername";
        KEY_PASSWORD = "fouruppassword";
        HOSTNAME = "4upFiles.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to 4upFiles.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("4upFiles.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("FourUpFilesAccount.html", responseString);
