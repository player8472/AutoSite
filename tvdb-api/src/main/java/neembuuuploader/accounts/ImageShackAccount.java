...
public class ImageShackAccount extends AbstractAccount {
    ...
    public void disableLogin() {
        resetLogin();
        HostsPanel.getInstance().imageShackCheckBox.setEnabled(false);
        HostsPanel.getInstance().imageShackCheckBox.setSelected(false);
    ...
    private void loginImageShack() throws Exception {
        ...
        */
        if (loginsuccessful) {
            ...
            HostsPanel.getInstance().imageShackCheckBox.setEnabled(true);
        } else {
            //Handle errors
