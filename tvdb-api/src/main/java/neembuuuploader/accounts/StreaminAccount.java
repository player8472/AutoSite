 ...
 * @author MNidhal
 */
public class StreaminAccount extends AbstractAccount{
    ...
    public StreaminAccount() {
        KEY_USERNAME = "strminusername";
        KEY_PASSWORD = "strminpassword";
        HOSTNAME = "Streamin.com";
    }

    @Override
    public void disableLogin() {
        resetLogin();
        HostsPanel.getInstance().streamInCheckBox.setEnabled(false);
        HostsPanel.getInstance().streamInCheckBox.setSelected(false);
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to Streamin.com");
            ...
            if (lastHeader != null && lastHeader.getValue().contains("op=my_account")) {
                ...
                HostsPanel.getInstance().streamInCheckBox.setEnabled(true);
                NULogger.getLogger().info("Streamin.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("StreaminAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from Streamin.com");
