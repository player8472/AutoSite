...
public class EnterUploadAccount extends AbstractAccount {
    ...
    public void disableLogin() {
        ...
        HostsPanel.getInstance().enterUploadCheckBox.setEnabled(false);
        HostsPanel.getInstance().enterUploadCheckBox.setSelected(false);
...
//            String httpResp = br.readLine();
        ...
        if (!logincookie.isEmpty() && !xfsscookie.isEmpty()) {
            ...
            HostsPanel.getInstance().enterUploadCheckBox.setEnabled(true);
