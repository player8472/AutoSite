 ...
 * @author Paralytic
 */
public class VidZiAccount extends AbstractAccount{
    ...
    public VidZiAccount() {
        KEY_USERNAME = "vidziusername";
        KEY_PASSWORD = "vidzipassword";
        HOSTNAME = "VidZi.tv";
    }
    ...
    public void disableLogin() {
        resetLogin();
        HostsPanel.getInstance().vidZiCheckBox.setEnabled(false);
        HostsPanel.getInstance().vidZiCheckBox.setSelected(false);
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to VidZi.tv");
            httpPost = new NUHttpPost("http://vidzi.tv");

            List<NameValuePair> formparams = new ArrayList<NameValuePair>();
            formparams.add(new BasicNameValuePair("op", "login"));
            formparams.add(new BasicNameValuePair("btn", "Enter"));
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfsts").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                HostsPanel.getInstance().vidZiCheckBox.setEnabled(true);
                NULogger.getLogger().info("VidZi.tv login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("VidZiAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from VidZi.tv");
        //responseString = NUHttpClientUtils.getData("http://vidzi.tv", httpContext);
    }
