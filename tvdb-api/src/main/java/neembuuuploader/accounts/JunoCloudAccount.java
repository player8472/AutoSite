 ...
 */
public class JunoCloudAccount extends AbstractAccount{
    ...
    public JunoCloudAccount() {
        KEY_USERNAME = "jncldusername";
        KEY_PASSWORD = "jncldpassword";
        HOSTNAME = "JunoCloud.me";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to JunoCloud.me");
            httpPost = new NUHttpPost("http://junocloud.me/");
            ...
            if (lastHeader != null && lastHeader.getValue().contains("op=my_files")) {
                ...
                //Get user type
                responseString = NUHttpClientUtils.getData("http://junocloud.me/home.html", httpContext);
                responseString = Jsoup.parse(responseString).select("div.status span.val").eq(1).text();
                ...
                NULogger.getLogger().info("JunoCloud.me login successful!");
                NULogger.getLogger().log(Level.INFO, "JunoCloud premium: {0}", premium);

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("JunoCloudAccount.html", responseString);
