 ...
 */
public class ArabLoads extends AbstractUploader{
    
    ArabLoadsAccount arabLoadsAccount = (ArabLoadsAccount) AccountsManager.getAccount("ArabLoads.net");
    ...
    public ArabLoads(File file) {
        super(file);
        downURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        delURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        host = "ArabLoads.net";
        if (arabLoadsAccount.loginsuccessful) {
            host = arabLoadsAccount.username + " | ArabLoads.net";
        }
    ...
    public void run() {
        try {
            if (arabLoadsAccount.loginsuccessful) {
                userType = "reg";
                httpContext = arabLoadsAccount.getHttpContext();
            ...
            NULogger.getLogger().info("Now uploading your file into ArabLoads.net");
            uploading();
            ...
            //FileUtils.saveInFile("ArabLoads.html", responseString);
