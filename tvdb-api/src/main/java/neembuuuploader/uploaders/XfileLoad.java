 ...
 * @author Paralytic
 */
public class XfileLoad extends AbstractUploader{
    
    XfileLoadAccount xfileLoadAccount = (XfileLoadAccount) AccountsManager.getAccount("XfileLoad.com");
    ...
    public XfileLoad(File file) {
        super(file);
        downURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        delURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        host = "XfileLoad.com";
        if (xfileLoadAccount.loginsuccessful) {
            host = xfileLoadAccount.username + " | XfileLoad.com";
        }
