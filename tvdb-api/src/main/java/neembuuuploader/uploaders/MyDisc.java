 ...
 * @author Paralytic
 */
public class MyDisc extends AbstractUploader{
    
    MyDiscAccount myDiscAccount = (MyDiscAccount) AccountsManager.getAccount("MyDisc.net");
    ...
    public MyDisc(File file) {
        super(file);
        downURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        delURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        host = "MyDisc.net";
        if (myDiscAccount.loginsuccessful) {
            host = myDiscAccount.username + " | MyDisc.net";
        }
