 ...
 * @author Paralytic
 */
public class FileCloudCc extends AbstractUploader{
    
    FileCloudCcAccount fileCloudCcAccount = (FileCloudCcAccount) AccountsManager.getAccount("FileCloud.cc");
    ...
    public FileCloudCc(File file) {
        super(file);
        downURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        delURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        host = "FileCloud.cc";
        if (fileCloudCcAccount.loginsuccessful) {
            host = fileCloudCcAccount.username + " | FileCloud.cc";
        }
    ...
    public void run() {
        try {
            if (fileCloudCcAccount.loginsuccessful) {
                userType = "reg";
                httpContext = fileCloudCcAccount.getHttpContext();
            ...
            NULogger.getLogger().info("Now uploading your file into FileCloud.cc");
            uploading();
            ...
            if (upload_fn != null) {
                httpPost = new NUHttpPost("http://filecloud.cc");
