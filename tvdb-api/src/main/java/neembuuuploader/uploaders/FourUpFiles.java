 ...
 * @author Paralytic
 */
public class FourUpFiles extends AbstractUploader{
    
    FourUpFilesAccount fourUpFilesAccount = (FourUpFilesAccount) AccountsManager.getAccount("4upFiles.com");
    ...
    public FourUpFiles(File file) {
        super(file);
        downURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        delURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        host = "4upFiles.com";
        if (fourUpFilesAccount.loginsuccessful) {
            host = fourUpFilesAccount.username + " | 4upFiles.com";
        }
