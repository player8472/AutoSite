...
public class ClickToWatch extends AbstractUploader implements UploaderAccountNecessary{
    ...
    ClickToWatchAccount clickToWatchAccount = (ClickToWatchAccount) AccountsManager.getAccount("ClickToWatch.net");
    ...
    public ClickToWatch(File file) {
        super(file);
        downURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        delURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        host = "ClickToWatch.net";
        if (clickToWatchAccount.loginsuccessful) {
            host = clickToWatchAccount.username + " | ClickToWatch.net";
        }
    ...
    public void run() {
        try {
            if (clickToWatchAccount.loginsuccessful) {
                userType = "reg";
                httpContext = clickToWatchAccount.getHttpContext();
            ...
            // http://clicktowatch.net/cgi-bin/upload.cgi?upload_id=
            ...
            NULogger.getLogger().info("Now uploading your file into ClickToWatch.net");
            uploading();
