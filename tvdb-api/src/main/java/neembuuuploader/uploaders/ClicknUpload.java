 ...
 * @author Paralytic
 */
public class ClicknUpload extends AbstractUploader{
    
    ClicknUploadAccount clicknUploadAccount = (ClicknUploadAccount) AccountsManager.getAccount("ClicknUpload.com");
    ...
    public ClicknUpload(File file) {
        super(file);
        downURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        delURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        host = "ClicknUpload.com";
        if (clicknUploadAccount.loginsuccessful) {
            host = clicknUploadAccount.username + " | ClicknUpload.com";
        }
    ...
    public void run() {
        try {
            if (clicknUploadAccount.loginsuccessful) {
                userType = "reg";
                httpContext = clicknUploadAccount.getHttpContext();
            ...
            NULogger.getLogger().info("Now uploading your file into ClicknUpload.com");
            uploading();
            ...
            if (upload_fn != null) {
                httpPost = new NUHttpPost("http://clicknupload.com/");
