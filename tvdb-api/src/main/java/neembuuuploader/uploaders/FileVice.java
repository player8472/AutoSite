 ...
 * @author Paralytic
 */
public class FileVice extends AbstractUploader{
    
    FileViceAccount fileViceAccount = (FileViceAccount) AccountsManager.getAccount("FileVice.com");
    ...
    public FileVice(File file) {
        super(file);
        downURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        delURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        host = "FileVice.com";
        if (fileViceAccount.loginsuccessful) {
            host = fileViceAccount.username + " | FileVice.com";
        }
    ...
    public void run() {
        try {
            if (fileViceAccount.loginsuccessful) {
                userType = "reg";
                httpContext = fileViceAccount.getHttpContext();
            ...
            NULogger.getLogger().info("Now uploading your file into FileVice.com");
            uploading();
            ...
            if (upload_fn != null) {
                httpPost = new NUHttpPost("http://filevice.com/");
