 ...
 * @author Paralytic
 */
public class FileStorm extends AbstractUploader implements UploaderAccountNecessary{
    
    FileStormAccount fileStormAccount = (FileStormAccount) AccountsManager.getAccount("FileStorm.to");
    ...
    public FileStorm(File file) {
        super(file);
        downURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        delURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        host = "FileStorm.to";
        if (fileStormAccount.loginsuccessful) {
            host = fileStormAccount.username + " | FileStorm.to";
        }
    ...
    public void run() {
        try {
            if (fileStormAccount.loginsuccessful) {
                userType = "reg";
                httpContext = fileStormAccount.getHttpContext();
            ...
            NULogger.getLogger().info("Now uploading your file into FileStorm.to");
            uploading();
