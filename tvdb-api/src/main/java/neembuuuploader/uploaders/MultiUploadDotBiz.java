...
public class MultiUploadDotBiz extends AbstractUploader{
    ...
    MultiUploadDotBizAccount multiUploadDotBizAccount = (MultiUploadDotBizAccount) AccountsManager.getAccount("MultiUpload.biz");
    ...
    public MultiUploadDotBiz(File file) {
        super(file);
