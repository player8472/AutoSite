 ...
 * @author Paralytic
 */
public class MightyUpload extends AbstractUploader{
    
    MightyUploadAccount mightyUploadAccount = (MightyUploadAccount) AccountsManager.getAccount("MightyUpload.com");
    ...
    private String uploadURL_unique_str = "";
    ...
    private void initialize() throws Exception {
        ...
        m = p.matcher(uploadURL);

        while (m.find()){
            uploadURL_unique_str = m.group();
        }
    }
