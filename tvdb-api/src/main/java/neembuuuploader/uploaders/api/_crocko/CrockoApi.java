 ...
 */
package neembuuuploader.uploaders.api._crocko;
...
import neembuuuploader.exceptions.uploaders.NUFileInBlackListException;
...
import neembuuuploader.exceptions.uploaders.NUUploadLimitExceededException;
...
public class CrockoApi {
    ...
    */    
    ...
    public static String getErrorMessage(){
        return TranslationProvider.get("neembuuuploader.exceptions."+convertErrorCode(error));
    }
