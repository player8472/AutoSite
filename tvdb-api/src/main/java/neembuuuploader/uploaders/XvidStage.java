 ...
 * @author MNidhal
 */
public class XvidStage extends AbstractUploader{
    
    XvidStageAccount xvidStageAccount = (XvidStageAccount) AccountsManager.getAccount("XvidStage.com");
    ...
    public XvidStage(File file) {
        super(file);
        downURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        delURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        host = "XvidStage.com";
        if (xvidStageAccount.loginsuccessful) {
            host = xvidStageAccount.username + " | XvidStage.com";
        }
    ...
    public void run() {
        try {
            if (xvidStageAccount.loginsuccessful) {
                userType = "reg";
                httpContext = xvidStageAccount.getHttpContext();
            ...
            NULogger.getLogger().info("Now uploading your file into XvidStage.com");
            uploading();
            ...
            //Read the links
            gettingLink();
            httpPost = new NUHttpPost("http://xvidstage.com");
            ...
            //FileUtils.saveInFile("XvidStage.html", responseString);
