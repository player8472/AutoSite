 ...
 * NamespaceContext </a>. Instances are immutable. It works for Crocko xml traversing (damned namespaces).
 * 
 * @author McDowell
 * @url <a href="http://illegalargumentexception.blogspot.it/2009/05/java-using-xpath-with-namespaces-and.html">url</a>
 * 
 */
