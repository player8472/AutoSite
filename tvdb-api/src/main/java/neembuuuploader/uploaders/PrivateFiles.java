 ...
 * @author Paralytic
 */
public class PrivateFiles extends AbstractUploader implements UploaderAccountNecessary{
    
    PrivateFilesAccount privateFilesAccount = (PrivateFilesAccount) AccountsManager.getAccount("PrivateFiles.com");
