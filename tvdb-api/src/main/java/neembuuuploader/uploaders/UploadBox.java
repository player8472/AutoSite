...
public class UploadBox extends AbstractUploader {
    ...
    public void run() {
        ...
        if (file.length() > fileSizeLimit) {
            JOptionPane.showMessageDialog(neembuuuploader.NeembuuUploader.getInstance(), "<html><b>" + getClass().getSimpleName() + "</b> " + TranslationProvider.get("neembuuuploader.exceptions.maxfilesize") + ": <b>2000MB</b></html>", getClass().getSimpleName(), JOptionPane.ERROR_MESSAGE);
