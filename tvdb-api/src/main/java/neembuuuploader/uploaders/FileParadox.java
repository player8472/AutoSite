 ...
 * @author MNidhal
 */
public class FileParadox extends AbstractUploader{
    
    FileParadoxAccount fileParadoxAccount = (FileParadoxAccount) AccountsManager.getAccount("FileParadox.in");
    ...
    public FileParadox(File file) {
        super(file);
        downURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        delURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        host = "FileParadox.in";
        if (fileParadoxAccount.loginsuccessful) {
            host = fileParadoxAccount.username + " | FileParadox.in";
        }
    ...
    public void run() {
        try {
            if (fileParadoxAccount.loginsuccessful) {
                httpContext = fileParadoxAccount.getHttpContext();
            ...
            NULogger.getLogger().info("Now uploading your file into FileParadox.in");
            uploading();
            ...
            //FileUtils.saveInFile("FileParadox.html", responseString);
