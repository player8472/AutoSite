 ...
 * @author Paralytic
 */
public class Verzend extends AbstractUploader{
    
    VerzendAccount verzendAccount = (VerzendAccount) AccountsManager.getAccount("Verzend.be");
    ...
    public Verzend(File file) {
        super(file);
        downURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        delURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        host = "Verzend.be";
        if (verzendAccount.loginsuccessful) {
            host = verzendAccount.username + " | Verzend.be";
        }
    ...
    private void initialize() throws Exception {
        responseString = NUHttpClientUtils.getData("http://verzend.be", httpContext);
