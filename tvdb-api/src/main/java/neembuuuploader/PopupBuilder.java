    ...
    private boolean canRetryUploadEnable() {
        ...
        for (int selectedrow : selectedrows) {
            if (UploadStatusUtils.isRowStatusOneOf(selectedrow, UploadStatus.UPLOADFAILED, 
                    UploadStatus.UPLOADSTOPPED, UploadStatus.RETRYFAILED)) {
                i++;
            }
        }


        retryUpload.setText(TranslationProvider.get("neembuuuploader.PopupBuilder.retryUpload"));
        if (i >= 1) {
            if (multiple) {
                retryUpload.setText(TranslationProvider.get("neembuuuploader.PopupBuilder.retryUpload") + " (" + i + ")");
            }
            return true;
        }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    for (int selectedrow : selectedrows) {
                        if (UploadStatusUtils.isRowStatusOneOf(selectedrow, UploadStatus.INITIALISING, UploadStatus.UPLOADING)) {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    for (int selectedrow : selectedrows) {
                        if (UploadStatusUtils.isRowStatusOneOf(selectedrow, UploadStatus.UPLOADFAILED, UploadStatus.UPLOADSTOPPED, UploadStatus.RETRYFAILED)) {
                            try {
